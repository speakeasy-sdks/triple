...
import (
	"context"
	triple "github.com/speakeasy-sdks/triple/v13"
	"log"
	"net/http"
)
...
import (
	...
	"errors"
	triple "github.com/speakeasy-sdks/triple/v13"
	"github.com/speakeasy-sdks/triple/v13/pkg/models/sdkerrors"
	"log"
)
...
func main() {
	s := triple.New(
		triple.WithServerURL("http://petstore.swagger.io/v1"),
	)
